...
export default function Footer() {
    return (
        <div className="footer-copy center bottom-0 relative items-center justify-center w-full backdrop-blur-md bg-black
        {/*bg-opacity-50*/}
        ">
                        ...
                        <div className="widget-content-one">
                            ...
                            {/*/>*/}
                                <div className="footer-social-section">
                                    <Link to="https://www.facebook.com" target="_blank" rel="noreferrer" className="footer-social-link w-inline-block">
                                        <img
                                            src="https://uploads-ssl.webflow.com/632787c41c814d0af1720348/632787c41c814deab9720377_social-icon-svg-1.svg"
                                            loading="lazy" alt="Footer Social Facebook" width="10"
                                    ...
                                    <a href="https://twitter.com/HonestPowerSol" target="_blank" rel="noreferrer" className="footer-social-link w-inline-block">
                                        <img
                                            src="https://uploads-ssl.webflow.com/632787c41c814d0af1720348/632787c41c814dbe39720378_social-icon-svg-2.svg"
                                            loading="lazy" alt="Footer Social Twitter" className="footer-social"
                                        />
                                    </a>
                                    <a href="https://www.linkedin.com/company/honest-power-solar/mycompany/" target="_blank"
                                       rel="noreferrer"
                                       className="footer-social-link w-inline-block">
                                        <img
                                            src="https://uploads-ssl.webflow.com/632787c41c814d0af1720348/632787c41c814da6c7720379_social-icon-svg-3.svg"
                                            loading="lazy" alt="Footer Social Linkedin" className="footer-social"
                                            style={{
                                                top:"28%",
                                                right: "-32%"
                                            }}
                                    ...
                                    <a href="https://www.instagram.com/honest.power.solar/" target="_blank"
                                       rel="noreferrer"
                                       className="footer-social-link w-inline-block">
                                        <img
                                            src="https://uploads-ssl.webflow.com/632787c41c814d0af1720348/632787c41c814dda7872037a_social-icon-svg-4.svg"
                                            loading="lazy" alt="Footer Social Instagram" className="footer-social"
                                            style={{
                                                height: "28px",
                                                top: "24%",
                                                right: "-22%"
                                ...
                                <div className="footer-copyright-text">
                                    <div className="copyright-text"><strong>©</strong> Honest Power&nbsp;LLC<br/></div>
                                </div>
                        </div>
                        <div className="widget-content-two">
                            <div className="widget-title-section"><h2 className="widget-title">Explore</h2></div>
                            <div className="footer-widget-links">
                                <a href="/" aria-current="page" className="footer-link w--current">Home</a>
                                <a href="/src/pages/About" className="footer-link">About</a>
                                <a href="/src/pages/Services" className="footer-link">Services</a>
                                <a href="/individual-services/commerical" className="footer-link">Commercial</a>
                                <a href="/contact-us" className="footer-link">Contact</a>
                            </div>
                        </div>
                        <div className="widget-content-three">
                            <div className="widget-title-section"><h2 className="widget-title">Contact</h2></div>
                            <div className="footer-contact-area">
                                <div className="address-section address-section-one">
                                    ...
                                    />
                                        <div className="address-text">21600 W Oxnard St Woodland Hills, CA 91367.</div>
                                </div>
                                <div className="address-section mail-content">
                                    <img
                                        ...
                                        loading="lazy" width="22" alt="" className="intro-image"
                                   />
                                        <a href="mailto:support@doctorate.com" className="address-text footer-link">info@myhonestpower.com</a>
                                </div>
                                <div className="address-section mail-content">
                                    <img
                                        ...
                                        loading="lazy" width="22" alt="" className="intro-image"
                                    />
                                        <a href="tel:+221234567900" className="address-text footer-link">(+1) 323-330-4665</a>
                                </div>
                            </div>
                        </div>
                        <div className="widget-content-four">
                            <div className="widget-title-section appointment-title"><h2 className="widget-title">Get a quote</h2>
                                <img
                            ...
                            <div id="Footer-Widget-Booking" className="footer-widget-booking">
                                <div className="footer-booking-text">Reach out to one of our solar specialists today</div>
                                <div className="booking-button">
                                    <a href="/contact-us" className="header-button-link-2 w-inline-block">
                                        <div className="header-button-2">
                                            <img
                                                ...
                                                loading="lazy" alt="Header Calendar Icons" className="header-calendar-icon"/>
