...
export default function ThemeController() {
    ...
    const handleThemeToggle = () => {
        setPrefersToggleTheme(!prefersToggleTheme);
    };

    return (
        <>
            <label className="swap swap-rotate fixed bottom-4 right-4 " data-testid="theme-controller">
                {/* this hidden checkbox controls the state */}
                <input
                    type="checkbox"
                    className="theme-controller"
                    checked={prefersToggleTheme}
