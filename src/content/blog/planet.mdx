...
snippet: >-
  Solar power is a big part of the solution to the climate crisis. Here's how to
  get started.
image:
  src: /blogimages/desert-solar.jpg
  alt: >-
    Desert with solar panels - what happens when we don't create a sustainable
    future.
...
//import IWCInterface from '../../components/blog/IWCInterface.astro';
...
{/* TODO: Bug fix expected a closing tag for "<a>" */}


{/* <IWCInterface
  filename="emma-francis-vpHCfunwDrQ-unsplash.jpg"
  anchorTag={`Photo by <a href="https://unsplash.com/@efranciswork?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Emma Francis</a> on <a href="https://unsplash.com/photos/glacier-near-body-of-water-vpHCfunwDrQ?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Unsplash</a>`}
  alt="Testing Alt"
> */}
